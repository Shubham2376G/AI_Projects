...
def xray_output():
    ...
    path = "models/lr3e-5_densenet_cuda.pth"
    ...
    model = eval(
        f'networks.get_densenet121(out_features=4, path="{path}")'
    ).cpu()
    ...
    image = utils.load_image("assets/original.jpg")
    ...
    # save the image
    utils.save_image(image, "outputs/output.jpg")
