...
mess=user_proxy.initiate_chat(
    assistant,
    message="format this: The delivery and activation of an eSIM prepay plan is instantaneous. Once you have completed the ordering process and received your confirmation email, you can scan the QR code in the email to activate your eSIM. Your eSIM will be activated immediately and you can start using your new mobile phone plan right away.",
    max_turns=1
)
...
print(hyperlink(mess.chat_history[1]["content"],database))
